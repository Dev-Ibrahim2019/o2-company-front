...
describe("getOrderReference — رقم قصير للواجهة بدون تغيير المعرف الأساسي", () => {
  it("يقتطع الشهر/اليوم + آخر مقطع من ORD-20260903-0001 (بدل التسلسل بمفرده، لتفادي تصادم بين أيام مختلفة)", () => {
    expect(getOrderReference("ORD-20260903-0001")).toBe("#0903-0001");
  });
