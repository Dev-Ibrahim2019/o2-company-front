...
// يتلقى employee للتعديل، أو null للإضافة.
...
const EmployeeModal = ({ employee, departments, branches, onSave, onClose }: Props) => {
    ...
    const validate = (): boolean => {
        ...
        if (!form.branch_id) newErrors.branch_id = "الفرع مطلوب";
        if (!form.department_id) newErrors.department_id = "القسم مطلوب";
        if (!form.hireDate) newErrors.hireDate = "تاريخ التوظيف مطلوب";
        setErrors(newErrors);
            ...
            <div className="bg-slate-900 border border-white/10 rounded-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className={labelCls}>رمز PIN (للحضور)</label>
                            <input
                                value={form.pin}
                ...
                <div className="flex items-center justify-end gap-3 p-6 border-t border-white/5 shrink-0">
                    ...
                    <button
                        ...
                        disabled={saving}
                        className="px-6 py-2 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-xl flex items-center gap-2 transition-colors disabled:opacity-50"
                    >
